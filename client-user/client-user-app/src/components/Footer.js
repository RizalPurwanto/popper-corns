            ...
            <div className="mx-6 py-10 text-center md:text-left">
                <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="font-semibold">
                        ...
                        <p className="mb-4">
                            <a href="#!" className="text-gray-600">Critic Submission</a>
                        </p>
                        <p className="mb-4">
                            <a href="#!" className="text-gray-600">Licensing</a>
                        </p>
                        <p className="mb-4">
                            <a href="#!" className="text-gray-600">Advertise</a>
                        </p>
                        <p>
                    ...
                    <div >
                        ...
                        <h6 className="uppercase font-bold mb-4 flex justify-center md:justify-start">
                            <a><i className="fa fa-envelope" ></i> Join the Newsletter</a>
                        </h6>
                        <p className="mb-4">
                            <a href="#!" className="text-gray-600">Get the poppest reviews, news, and more delivered right to your inbox!</a>
                        </p>
                        <p className="mb-4">
                            <button className="text-xs py-4	bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                JOIN THE NEWSLETTER
                            </button>
                        </p>
        ...
        <p className="flex items-center justify-center md:justify-start">
          ...
          + 01 234 567 89
            ...
            <div className="text-center p-6 bg-red-800">
                ...
                <a className="text-white font-semibold" href="https://tailwind-elements.com/"> Popper Corns</a>
            </div>
        </footer>
    )
